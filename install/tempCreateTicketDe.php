						...
						<tbody>
							<tr>
								<td colspan="4" style="padding:15px;">
									...
									<p style="font-size:15px; font-family:Verdana, Geneva, sans-serif;">Sie haben ein Ticket bei uns ge&ouml;ffnet. Wir werden uns so schnell wie m&ouml;glich darum k&uuml;mmern.</p>
								</td>
							</tr>
							<tr>
								<td colspan="4" style="padding:15px;">
