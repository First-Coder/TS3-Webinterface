						...
						<tbody>
							<tr>
								<td colspan="4" style="padding:15px;">
									...
									<p style="font-size:15px; font-family:Verdana, Geneva, sans-serif;">denn Serverantrag, denn Sie an %heading% gestellt haben, wurde leider abgewiesen.<br /><br />Wir w&uuml;schen Ihnen dennoch einen angenehmen Tag.</p>
								</td>
							</tr>
							<tr>
								<td colspan="4" style="padding:15px;">
