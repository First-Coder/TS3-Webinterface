						...
						<tbody>
							<tr>
								<td colspan="4" style="padding:15px;">
									...
									<p style="font-size:15px; font-family:Verdana, Geneva, sans-serif;">Sie haben einen Serverantrag an %heading% gestellt. Diese wird nun von uns bearbeitet. Sie erhalten in k&uuml;rze eine Antwort von uns.</p>
								</td>
							</tr>
