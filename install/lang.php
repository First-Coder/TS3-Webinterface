<?php
	...
	*/
	if(LANGUAGE == '' || LANGUAGE == 'english')
	{
		...
		// Step 3
		$language['benutzername_info']							=	"Caution: The username need to be a <b>valid</b> mailadress!";
		$language['passwort_info']								=	"Caution: The password <b>needs</b> a big letter, a small letter and a number!";
		...
		$language['install_ordner_loeschen']					=	"Please delete the \"install\" folder manually, if he exist!";
	}
	/*
		German language
	*/
	else if(LANGUAGE == 'german')
	{
		...
		// Step 3
		$language['benutzername_info']							=	"Der Benutzername <b>muss</b> eine g&uuml;ltige E-Mail Adresse sein!";
		$language['passwort_info']								=	"Das Password <b>muss</b> einen Gro&szlig;buchstaben, einen Kleinbuchstaben, sowie eine Zahl besitzen!";
		$language['benutzerdaten_angeben']						=	"Benutzerdaten angeben";
		$language['benutzerdaten_angeben_1']					=	"Es wird der obenstehende Benutzer erstellt. Dieser bekommt alle globalen Rechte f&uuml;r das Webinterface. Alle weiteren Einstellung bez&uuml;glich der Instanzen werden 
		...
		$language['install_ordner_loeschen']					=	"Bitte l&ouml;schen Sie den \"install\" Ordner manuell, falls dieser noch existiert!";
	};
?>