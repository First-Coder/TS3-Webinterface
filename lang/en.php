<?php
	...
	$language['server_application_info_1'] = "Do you urgently need a TeamSpeak3 server and do not find a suitable sponsor to support it?";
	$language['server_application_info_2'] = "Then they are exactly right here, because they can create a TeamSpeak3 server application for <strong>easy</strong>, <strong>free</strong> and <strong>non-binding</strong>.";
	...
	$language['server_application_info_5'] = "Overview of your TeamSpeak Server in the web interface, as well as the editing, restart, start or stop or create a backup are possible without problems.";
	...
	$language['port_cant_be_used'] = "Server port cannot be used!";
	...
	$language['homepage_info'] = "If you or your group has a site, please let us know.";
	...
	$language['version_info'] = "Version Information";
	...
	$language['dashboard_welcome_info2'] = "Here under this block you will find your servers and tickets. If you are on a computer / tablet, on the right is the navigation. Otherwise the navigation is via the Hamburger menu above left!";
	...
	$language['ip_info'] = "The IP address on which the TeamSpeak3 server is located. Please make sure the web interface is in the Whitelist!";
	$language['queryport_info'] = "Queryport of TeamSpeak3 Server (default: 10011)";
	$language['client_info_instanz'] = "Query User&#039;s User to TeamSpeak3 Server. (Default: serveradmin)";
	...
	$language['ssh_client_info'] = "External server shell user. <b>User root is not accepted!</b>";
	$language['ssh_password_info'] = "Shell password of the external server.";
	$language['ssh_folder_path_info'] = "Folder path of the external server for TeamSpeak files.";
	...
	$language['shell_restart_instanz'] = "Restart server instance";
	...
	$language['user_add_info2'] = "You can create multiple users with the same name without any problems!";
	...
	$language['ts3_rights_edit_info'] = "TeamSpeak3 Instance settings give you the right to change the user, password, queryport, and IP address of each TeamSpeak3 instance";
	...
	$language['delete_server_info'] = "Right, if user can delete TeamSpeak server";
	$language['access_to_all_server'] = "Access to all servers";
	$language['access_to_all_server_info'] = "Access to all TeamSpeak server, with all rights, on each instance!";
	...
	$language['server_start_stop_info'] = "This right allows the user to start and stop the TeamSpeak server.";
	...
	$language['server_protokoll_info'] = "This right allows the user to view logs of the TeamSpeak server.";
	...
	$language['server_filelist_info'] = "This right allows the user to manage files that reside on the TeamSpeak server&#039;s channels.";
	...
	$language['client_permission_info'] = "This right allows the user to assign other users to server and channel groups.";
	$language['channel_actions'] = "Channel actions";
	$language['channel_actions_info'] = "This right allows the user to perform actions such as channel kicks, channel bans, etc.";
	$language['server_edit'] = "Edit the server";
	$language['server_edit_subcategory'] = "Show subcategories";
	$language['server_edit_info'] = "This right allows the user to edit the TeamSpeak server. If you want to edit the server but not all points, please click on &quot;Show Subcategories&quot;.";
	...
	$language['change_default_group'] = "Change default groups";
	...
	$language['change_protokollsettings'] = "Change logs settings";
	...
	$language['server_msg_poke_done'] = "Server message / Server poke has been successfully send!";
	$language['server_started'] = "Server started successfully!";
	$language['server_stoped'] = "Server successfully stopped!";
	$language['tree_loading'] = "Loading the TeamSpeak server tree ...";
	...
	$language['serverpoke_done'] = "Server poke successfully send!";
	$language['teamspeak_information'] = "TeamSpeak information";
	...
	$language['error_webinterface_info1'] = "The Homepage could not be displayed, cause we have critical errors with the database. If the Homepage installation was not successfull be sure the install folder exists on the main folder of the interface!";
	...
	$language['ssh_key_info'] = "In order to get the key into the select menu, you need to upload the key files to <b>/files/shell/</b>.<br/>x => PRIVATE KEY, x.ppk => PUBLIC KEY (x means the filename)!";
	$language['password_reset_success'] = "Password successful resetted!";
